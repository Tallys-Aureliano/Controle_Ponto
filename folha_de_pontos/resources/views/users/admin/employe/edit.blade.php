...
<form action="{{ route('admin.employe.update', ['id'=>$user->id]) }}" method="POST">
	...
	<input type="email" class="form-control @if($errors->has('email')) is-invalid @endif" placeholder="Email" name="email" value="{{ $user->email }}" required>
	@if($errors->has('email'))
	<div class="invalid-feedback">
	...
	<input type="text" class="form-control @if($errors->has('cpf')) is-invalid @endif" placeholder="Cpf" name="cpf" value="{{ $user->cpf }}" required maxlength="191">
	@if($errors->has('cpf'))
	<div class="invalid-feedback">
	...
	<input type="number" class="form-control @if($errors->has('matricula')) is-invalid @endif" placeholder="Matricula" name="matricula" value="{{ $user->matricula }}" maxlength="25">
